...
static void init_program(GLContext* context, const GLchar* vertex_src, const GLchar* fragment_src) {
  ...
  if (GL_TRUE != params) {
    ...
    glGetProgramInfoLog(context->program, GL_MAX_DEBUG_MESSAGE_LENGTH, NULL, program_log);
